			...
			return (
				<div>
					...
					{!this.state.loadingOrder?<div style={{margin:"10px",padding:"10px"}}>
						<button className={"submitOrderButton"} disabled={!this.props.user.userEmail || !this.props.user.userPhone || !this.props.user.userName || !this.props.user.userTable } onClick={()=>this.submitOrder()}>Submit Order</button>
